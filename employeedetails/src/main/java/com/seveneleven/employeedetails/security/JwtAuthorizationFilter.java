package com.seveneleven.employeedetails.security;
...
import com.seveneleven.employeedetails.EmployeedetailsApplication;
...
public class JwtAuthorizationFilter<Claims> extends BasicAuthenticationFilter {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(EmployeedetailsApplication.class);
